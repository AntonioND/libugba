...
int main(int argc, char *argv[])
{
    ...
    memcpy(spr_pal, ball_redPal, ball_redPalLen);

    spr_pal = MEM_PALETTE_OBJ + (BALL_GREEN_PALETTE * 16);
    memcpy(spr_pal, ball_greenPal, ball_greenPalLen);
...
#define TILE_SIZE (4 * 8 * 8) / 8
    ...
    memcpy(spr_tiles, ball_redTiles, ball_redTilesLen);

    spr_tiles = (uint8_t *)MEM_VRAM_OBJ + (BALL_GREEN_TILES_BASE * TILE_SIZE);
    memcpy(spr_tiles, ball_greenTiles, ball_greenTilesLen);
